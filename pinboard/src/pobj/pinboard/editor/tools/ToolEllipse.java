...
public class ToolEllipse implements Tool {
	...
	public ToolEllipse() {
		ellipse = new ClipEllipse(0,0, 0, 0, Color.BLACK);
		setColorAleatoire();
	}
	
	@Override
	public void press(EditorInterface i, MouseEvent e) {
		ellipse = new ClipEllipse(e.getX(), e.getY(), 0, 0, color);
		fixedX = e.getX();
		fixedY = e.getY();
	...
	public void drag(EditorInterface i, MouseEvent e) {
		...
		ellipse.setGeometry(left, top, right, bottom);
	}

	@Override
	public void release(EditorInterface i, MouseEvent e) {
		//i.getBoard().addClip(ellipse);
		addC = new CommandAdd(i,ellipse);
